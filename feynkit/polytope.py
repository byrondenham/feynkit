...
class Facet:
    ...
    lattice_normal, lattice_offset
        ...
        hand.
    lattice_index
        g_F, the gcd over the points of offset - normal . alpha_j. The form
        homogenised_form / g_F is primitive with respect to the lattice ZA
        generated by the columns (1, alpha_j).
    """
    ...
    def lattice_form(self) -> tuple[Fraction, ...]:
        """homogenised_form / g_F: primitive on ZA, non-negative on the columns, zero exactly on F.

        For a lower-dimensional P it is defined modulo the affine-hull forms.
        """
...
class PolytopeData:
    ...
    affine_hull
        ...
        the polytope, a basis in Hermite normal form of the integer forms
        vanishing on its affine hull; empty when it is full-dimensional.
    chart
